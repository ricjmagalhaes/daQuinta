 ...
 * @author toshiba
 */
public class ListaArmazenaveis extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaArmazenaveis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ListaArmazenaveis().setVisible(true);
            }
        });
    }
    ...
    private void DoConnect() {
       try {
            ...
            //Restaurante 1
            String sql1 = "SELECT "+dbName+".produtos.nome, "+dbName+".stock.quantidade FROM "+dbName+".produtos "
                    + "INNER JOIN "+dbName+".stock ON "+dbName+".produtos.idprodutos="+dbName+".stock.produtos_idprodutos "
                    + "WHERE "+dbName+".stock.produtores_idprodutores=1 and "+dbName+".stock.ano='" + ano +"'";
            ...
            //date2 = rsProdutosRestauranteA1.getDate("stock.ano");
            ...
            while (rsProdutosRestauranteA1.next()){ 
               ...
               for(j=0;j<RAItemList.length;j++)  {
                    if (rsProdutosRestauranteA1.getString("produtos.nome").equals(RAItemList[j]) && rsProdutosRestauranteA1.getInt("stock.quantidade")!=0) {
                            RAItemList2[j] = RAItemList2[j] + rsProdutosRestauranteA1.getInt("stock.quantidade");
                             control=true;
                            break;
                    }
               }
               if (control==false && rsProdutosRestauranteA1.getInt("stock.quantidade")!=0) {
                    RAItemList[linha] = rsProdutosRestauranteA1.getString("produtos.nome"); //get the element in column "item_code"
                    RAItemList2[linha] = rsProdutosRestauranteA1.getInt("stock.quantidade"); //get the element in column "item_code"
                    linha++;
               }              
            }
           for(j=0;j<linha;j++)  
           ...
           //Restaurante 2
           sql1 = "SELECT "+dbName+".produtos.nome, "+dbName+".stock.quantidade FROM "+dbName+".produtos "
                    + "INNER JOIN "+dbName+".stock ON "+dbName+".produtos.idprodutos="+dbName+".stock.produtos_idprodutos "
                    + "WHERE "+dbName+".stock.produtores_idprodutores=2 and "+dbName+".stock.ano='" + ano +"'";
            ...
            while (rsProdutosRestauranteB1.next()){ 
               ...
               for(j=0;j<RBItemList.length;j++)  {
                    if (rsProdutosRestauranteB1.getString("produtos.nome").equals(RBItemList[j]) && rsProdutosRestauranteB1.getInt("stock.quantidade")!=0) {
                            RBItemList2[j] = RBItemList2[j] + rsProdutosRestauranteB1.getInt("stock.quantidade");
                             control=true;
                            break;
                    }
               }
               if (control==false && rsProdutosRestauranteB1.getInt("stock.quantidade")!=0) {
                    RBItemList[linha] = rsProdutosRestauranteB1.getString("produtos.nome"); //get the element in column "item_code"
                    RBItemList2[linha] = rsProdutosRestauranteB1.getInt("stock.quantidade"); //get the element in column "item_code"
                    linha++;
               }              
           ...
           sql1 = "select "+dbName+".produtos.nome, "+dbName+".stock.quantidade from "+dbName+".produtos "
                    + "INNER JOIN "+dbName+".stock ON "+dbName+".produtos.idprodutos="+dbName+".stock.produtos_idprodutos "
                    + "WHERE "+dbName+".stock.produtores_idprodutores=3 and "+dbName+".stock.ano='" + ano +"'";
            ...
            while (rsProdutosRestauranteC1.next()){ 
               ...
               for(j=0;j<RCItemList.length;j++)  {
                    if (rsProdutosRestauranteC1.getString("produtos.nome").equals(RCItemList[j]) && rsProdutosRestauranteC1.getInt("stock.quantidade")!=0) {
                            RCItemList2[j] = RCItemList2[j] + rsProdutosRestauranteC1.getInt("stock.quantidade");
                             control=true;
                            break;
                    }
               }
               if (control==false && rsProdutosRestauranteC1.getInt("stock.quantidade")!=0) {
                    RCItemList[linha] = rsProdutosRestauranteC1.getString("produtos.nome"); //get the element in column "item_code"
                    RCItemList2[linha] = rsProdutosRestauranteC1.getInt("stock.quantidade"); //get the element in column "item_code"
                    linha++;
               }              
            }
           for(j=0;j<linha;j++)  
          ...
          //Restaurante 4
           sql1 = "select "+dbName+".produtos.nome, "+dbName+".stock.quantidade from "+dbName+".produtos "
                    + "INNER JOIN "+dbName+".stock ON "+dbName+".produtos.idprodutos="+dbName+".stock.produtos_idprodutos "
                    + "WHERE "+dbName+".stock.produtores_idprodutores=4 and "+dbName+".stock.ano='" + ano +"'";
            ...
            while (rsProdutosRestauranteD1.next()){ 
               ...
               for(j=0;j<RDItemList.length;j++)  {
                    if (rsProdutosRestauranteD1.getString("produtos.nome").equals(RDItemList[j]) && rsProdutosRestauranteD1.getInt("stock.quantidade")!=0) {
                            RDItemList2[j] = RDItemList2[j] + rsProdutosRestauranteD1.getInt("stock.quantidade");
                             control=true;
                            break;
                    }
               }
               if (control==false && rsProdutosRestauranteD1.getInt("stock.quantidade")!=0) {
                    RDItemList[linha] = rsProdutosRestauranteD1.getString("produtos.nome"); //get the element in column "item_code"
                    RDItemList2[linha] = rsProdutosRestauranteD1.getInt("stock.quantidade"); //get the element in column "item_code"
                    linha++;
               }              
            }
           for(j=0;j<linha;j++)  
           ...
           sql1 = "select "+dbName+".produtos.nome, "+dbName+".stock.quantidade from "+dbName+".produtos "
                    + "INNER JOIN "+dbName+".stock ON "+dbName+".produtos.idprodutos="+dbName+".stock.produtos_idprodutos "
                    + "WHERE "+dbName+".stock.produtores_idprodutores=5 and "+dbName+".stock.ano='" + ano +"'";
           ...
           rsProdutosRestauranteE1.next();
            ...
            while (rsProdutosRestauranteE1.next()){ 
               ...
               for(j=0;j<REItemList.length;j++)  {
                    if (rsProdutosRestauranteE1.getString("produtos.nome").equals(REItemList[j]) && rsProdutosRestauranteE1.getInt("stock.quantidade")!=0) {
                            REItemList2[j] = REItemList2[j] + rsProdutosRestauranteE1.getInt("stock.quantidade");
                             control=true;
                            break;
                    }
               }
               if (control==false && rsProdutosRestauranteE1.getInt("stock.quantidade")!=0) {
                    REItemList[linha] = rsProdutosRestauranteE1.getString("produtos.nome"); //get the element in column "item_code"
                    REItemList2[linha] = rsProdutosRestauranteE1.getInt("stock.quantidade"); //get the element in column "item_code"
                    linha++;
               }              
            }
           for(j=0;j<linha;j++)  
         ...
         for (int i=0;i<modelRestauranteD.size();i++){
          ...
          for(j=0;j<totalProdutos;j++)  {
           ...
           jListTotal1.setModel(modelRestauranteTotais);
            ...
            JOptionPane.showMessageDialog(ListaArmazenaveis.this, err.getMessage());
        }
    }
}
